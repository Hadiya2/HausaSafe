...
**An open-source Hausa language AI safety evaluation suite**

Created by [Hadiya Usman](https://www.linkedin.com/in/hadiyausman/) |
Stakeholder Relations Officer, New Incentives |
Director of Research, Nudge Innovation Hub |
Strategic Advisor, African Institute for Artificial Intelligence

---

## What is HausaSafe?

HausaSafe is an open-source project building the first structured Hausa-language
resource for AI safety evaluation. It documents where AI safety concepts break down
in Hausa, provides translated evaluation prompts for testing AI model behaviour, and
...
When I sat down to translate an AI safety awareness pamphlet into Hausa for a community
project, I discovered that foundational AI safety concepts have no Hausa equivalents:

- **Deepfakes** — required a full explanatory sentence in Hausa. The word does not exist.
- **Prompt** (in its AI meaning) — no Hausa equivalent at all. Not an approximate one.
  Not a borrowed one. Nothing.
...
For the full argument, read my EA Forum post: [Epistemic Exclusion of the Hausa Language in AI Safety](https://forum.effectivealtruism.org/posts/utZcwXd65yggubonn/epistemic-exclusion-of-the-hausa-language-in-ai-safety)
...
**Hadiya Usman**
Stakeholder Relations Officer, New Incentives (GiveWell Top Charity)
Director of Research, Nudge Innovation Hub
Strategic Advisor, African Institute for Artificial Intelligence
MPA in Economic and Sustainable Development, Iconic Open University (2026)
BlueDot Impact AGI Strategy Course Alumna, Group 18 (2026)

LinkedIn: [linkedin.com/in/hadiyausman](https://www.linkedin.com/in/hadiyausman/)
GitHub: [github.com/Hadiya2](https://github.com/Hadiya2)

If you use HausaSafe in your research or work, please cite this repository and
attribute Hadiya Usman as the creator under the CC BY 4.0 license.
...
You are free to use, share, and adapt this work as long as you give appropriate
credit to Hadiya Usman.
